...
reports **67 failing assertions in those categories**, against 480 suite-wide. The RSP's 291 are
...
Of the 67: COP1 13 (`CVT` edge cases, `MUL`/`DIV` residue), and ~64 across COP0 registers, the
