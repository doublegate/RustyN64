...
reports **89 failing assertions in those categories**, against 502 suite-wide. The RSP's 291 are
...
Of the 89: COP1 35 (`CVT` edge cases, `MUL`/`DIV` residue), and ~64 across COP0 registers, the
